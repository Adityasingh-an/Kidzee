...
import { ArrowRight, Book, Sun, Palette } from 'lucide-react';
...
const programs = [
  ...
  },
  {
    ...
    duration: '2.5 Hours/Day',
    desc: "To set a firm foundation in the early years of preschool, quality early childhood education is vital for the overall development of a child...",
  ...
  },
  {
    ...
    desc: "At Kidzee, the Kindergarten (KG) curriculum ensures a smooth transition to formal schooling...",
...
export default function Programs({ setShowEnquiry }) {
  return (
      ...
      <div className="container mx-auto px-4 md:px-12 lg:px-24">
        ...
        <div className="text-center mb-16">
          <h2 className="text-4xl md:text-6xl font-black text-primary font-heading relative inline-block">
            Programmes
            <svg className="absolute -bottom-2 left-0 w-full h-3 text-secondary" viewBox="0 0 100 10">
          ...
          {programs.map((prog, idx) => (
            ...
            >
              ...
              <button 
                ...
                className="mt-auto w-full py-3 px-6 bg-primary text-white font-bold rounded-xl flex items-center justify-center gap-2 group-hover:bg-secondary group-hover:text-primary transition-all duration-300 shadow-md"
              >
                Enquire Now
